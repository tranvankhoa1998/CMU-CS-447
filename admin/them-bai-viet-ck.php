...
<form action="them-bai-viet-ck.php" method="post">
	<table>
		...
		<tr>
			<td nowrap="nowrap"> Truyền thuyết :</td>
			<td><input type="checkbox" id="is_public" name="is_public" value="1"> </td>
		</tr>
		<tr>
			<td nowrap="nowrap">Dả sử :</td>
			<td><input type="checkbox" id="is_public" name="is_public" value="2"> </td>
		</tr>
		<tr>
			<td nowrap="nowrap">chính sử :</td>
			<td><input type="checkbox" id="is_public" name="is_public" value="3"> </td>
		</tr>
		<tr>
